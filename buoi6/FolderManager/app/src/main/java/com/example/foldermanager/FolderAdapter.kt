...
class FolderAdapter(var context: Context, var list: MutableList<Folder>) : RecyclerView.Adapter<FolderAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener, View.OnLongClickListener {
        ...
        private fun confirmDelete(position: Int){
            ...
            deleteDialog.setPositiveButton("Có", DialogInterface.OnClickListener { dialogInterface, i ->
            ...
            deleteDialog.setNegativeButton("Không", DialogInterface.OnClickListener { dialogInterface, i ->
                dialogInterface.cancel()
            })
